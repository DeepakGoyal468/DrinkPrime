...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="<?php echo e(asset('css/createlead.css')); ?>">

    <title>DrinkPrime | Create Lead</title>
</head>
    ...
    <section class="main">
        ...
        <main class="main-content">
            <div class="content-header">
                <div class="PageInfo">
                    <h1 class="page-title">Lead Information</h1>
                </div>
            </div>
            <div class="content-body">
                ...
                <?php endif; ?>
                    <form class="create-lead" action="<?php echo e(route('createLead')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button type="submit" class="btn btn-create btn-primary">Create Lead</button>
                            </div>
                        </div>
                    </form>
                </div>
